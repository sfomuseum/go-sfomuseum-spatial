module github.com/sfomuseum/go-sfomuseum-spatial

go 1.23

require (
	github.com/sfomuseum/go-sfomuseum-placetypes v0.0.6
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-spatial-sqlite v0.9.1 // indirect
